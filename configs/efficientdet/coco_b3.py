...
model = dict(
    type='RetinaNet',
    # pretrained=None,
    pretrained='/dahuafs/userdata/46799/mmdetection/weights/efficientnet-b3-5fb5a3c3.pth',
    backbone=dict(
        type='EfficientNet',
...
data = dict(
    ...
    test=dict(
        ...
        pipeline=test_pipeline))
# optimizer
optimizer = dict(type='SGD', lr=0.055, momentum=0.9, weight_decay=4e-5)
# optimizer = dict(type='Adam', lr=1e-3)

optimizer_config = dict(grad_clip=dict(max_norm=10.0, norm_type=2))


out_dir = './work_dirs/coco_b3-baseline'
interval = 1
...
load_from = None
# resume_from = None
resume_from = './work_dirs/coco_b3-baseline/epoch_69.pth'
auto_resume = True
workflow = [('train', 1)]
